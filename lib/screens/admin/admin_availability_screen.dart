...
class AdminAvailabilityScreen extends StatelessWidget {
  const AdminAvailabilityScreen({ Key? key }) : super(key: key);

  static const routeName = '/admin-availability';
                          ...
                          children: [
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (ctx, index) => ListTile(
                                title: Text(aTime[index]['day']),
                                trailing: IconButton(onPressed: (){}, icon: const Icon(Icons.border_color_outlined))
                              ),
                            ),
                            const SizedBox(
                              height: 20,
